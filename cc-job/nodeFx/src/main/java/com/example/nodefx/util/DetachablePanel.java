    ...
    public void detach() {
        ...
        javafx.application.Platform.runLater(() -> {
            ...
            javafx.application.Platform.runLater(() -> {
                ...
                if (content instanceof com.example.nodefx.view.MiniMapView) {
                    javafx.application.Platform.runLater(() -> {
                        ((com.example.nodefx.view.MiniMapView) content).refresh();
                        System.out.println("📍 小地图已刷新，Canvas尺寸: " + 
                            ((com.example.nodefx.view.MiniMapView) content).getCanvas().getWidth() + " x " + 
                            ((com.example.nodefx.view.MiniMapView) content).getCanvas().getHeight());
                    });
                }
            });
        });
