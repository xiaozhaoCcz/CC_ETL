...
靠此项目拿到国企offer和多个中小公司offer，想进大厂还是得有高并发经验
---

## 🔗 项目地址

后台平台地址: http://175.178.249.190/ccetlAdmin

pc端平台地址: 在发行包下(目前只是测试版本)
...
<div align="center">
  ...
  <img src="./doc/image/img-md/11.png" width="45%"/>
  <img src="./doc/image/img-md/12.png" width="45%"/>
  <img src="./doc/image/img-md/13.png" width="45%"/>
  <img src="./doc/image/img-md/14.png" width="45%"/>
</div>
...
#### ⚙️ 执行器配置（以 xxl-job-executor-sample-springboot 为例）
