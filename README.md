 ...
 **求一起开发的小伙伴，一个人工作量太大了，可做简历项目，后续准备所有功能，所有代码使用c#重构，目前核心任务功能已使用c#重构完** 。

 **后续要完成功能** 

1.支持更多同步数据源，

2.实现权限管控，不同用户管理不同的任务，

3.任务调度重构，目前任务调度执行器在调度中心，需要抽离出来重构，

4.支持条件节点，比如if else条件节点，

5.不再有后台管理页面，所有功能配置全部放在前台页面，使用c#做一个桌面端软件
