package com.cc.job.core.aspect;
...
public class LogAspect {
    ...
    @Pointcut("@annotation(com.cc.job.common.annotation.Log)")
    ...
    public Object logExecutionTime(ProceedingJoinPoint joinPoint, Log logAnnotation) throws Throwable {
        ...
        // 创建日志记录
        com.cc.job.system.model.entity.Log log = new com.cc.job.system.model.entity.Log();
