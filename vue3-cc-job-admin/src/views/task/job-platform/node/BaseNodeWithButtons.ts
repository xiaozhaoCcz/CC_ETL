    ...
    return h(
      ...
      [
        ...
        h(
          "g",
          {
            transform: `translate(${x - width / 2 + width - 150}, ${y - height / 2 - 30})`, // 定位图标
            cursor: "pointer",
        ...
        h(
          "g",
          {
            transform: `translate(${x - width / 2 + width - 120}, ${y - height / 2 - 30})`, // 定位图标
            cursor: "pointer",
        ...
        h(
          "g",
          {
            transform: `translate(${x - width / 2 + width - 90}, ${y - height / 2 - 30})`, // 定位图标
            cursor: "pointer",
        ...
        h(
          "g",
          {
            transform: `translate(${x - width / 2 + width - 60}, ${y - height / 2 - 30})`, // 定位图标
            cursor: "pointer",
        ...
        h(
          "g",
          {
            transform: `translate(${x - width / 2 + width - 30}, ${y - height / 2 - 30})`,
            cursor: "pointer",
