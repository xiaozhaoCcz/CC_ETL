  ...
  <div class="app-container">
    ...
    <el-card shadow="never" class="table-container">
      <template #header>
        ...
        <el-button
            v-hasPerm="['task:taskInfo:delete']"
            type="danger"
    ...
    >
      <el-form ref="dataFormRef" :model="formData" :rules="rules" label-width="100px">
                ...
                <el-form-item label="上次调度时间" prop="triggerLastTime">
                      <el-input
                          v-model="formData.triggerLastTime"
                          placeholder="上次调度时间"
                      />
                </el-form-item>
                <el-form-item label="下次调度时间" prop="triggerNextTime">
                      <el-input
                          v-model="formData.triggerNextTime"
                          placeholder="下次调度时间"
                      />
                </el-form-item>
      </el-form>
...
<script setup lang="ts">
  ...
  import TaskInfoAPI, { TaskInfoPageVO, TaskInfoForm, TaskInfoPageQuery } from "@/api/task/task-info";
  ...
  const rules = reactive({
                      ...
                      scheduleConf: [{ required: true, message: "请输入调度配置，值含义取决于调度类型", trigger: "blur" }],
                      executorRouteStrategy: [{ required: true, message: "请输入执行器路由策略", trigger: "blur" }],
                      ...
                      executorBlockStrategy: [{ required: true, message: "请输入阻塞处理策略", trigger: "blur" }],
                      ...
                      childJobid: [{ required: true, message: "请输入子任务ID，多个逗号分隔", trigger: "blur" }],
  });
